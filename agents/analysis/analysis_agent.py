...
**1. 도입부 (1문단)**
전체 상황을 한 문단으로 자연스럽게 요약합니다.
예시: "2025년 4분기 북미 시장의 매출 감소는 주로 A, B, 그리고 C가 맞물리며 발생한 것으로 분석됩니다."
...
예시:
```
1. 강력한 관세 정책과 인플레이션 재점화
관세 효과의 본격화: 2025년 초부터 예고되었던 관세 인상 정책이 실제 수입 물가에 반영되면서 제품 가격이 상승했습니다 [1]. 이전 분기에는 관세 부과 전 '밀어내기 수입'으로 재고를 확보했으나, 4분기에 들어서며 이 재고가 소진되고 관세가 적용된 고가 재고가 시장에 풀리며 소비를 압박했습니다.

실질 소득 감소: 고금리 기조가 유지되는 상황에서 물가가 다시 반등함에 따라 소비자들의 실질 구매력이 낮아졌고, 이는 소매 판매 및 서비스 매출 감소로 이어졌습니다 [2][3].
```

### 내용 지침

1. **자연스러운 문장**: 기계적인 구조([배경], [인과관계] 등) 사용 금지
2. **구체적 사례**: 기업명, 정책명, 수치 등 구체적 내용 포함
3. **인과관계 명확히**: A → B → C 형태의 논리적 연결
4. **출처 인용**: 관련 내용에 [1], [2] 형식으로 자연스럽게 삽입
5. **정량적 기여도 금지**: "X% 기여", "Y억 영향" 등 수치적 기여도 계산하지 말 것

### 금지 표현
- ❌ **[배경/맥락]**, **[인과관계 설명]** 등 구조적 헤더
- ❌ "~로 분석됩니다", "~로 판단됩니다" 반복
- ❌ "이 요인은...", "이러한 요인이..." 등 딱딱한 표현
